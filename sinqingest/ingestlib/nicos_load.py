...
def read_data(filename, fp):
    ...
    if not dtline.startswith('### NICOS data file'):
        raise Exception('%r does not appear to be a NICOS data file' %
                        filename)
    ...
    # This dies with a list error. For ingestion, I only need 
    # the meta data, such that I get me this out and abandon
    # debugging the code.... 
