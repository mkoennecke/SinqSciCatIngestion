""""
This module provides the ingestion meta data for AMOR
...
def readIngestionData(filename, scicat, owner, accessGroups):
    ...
    meta['creationLocation'] = 'AMOR at SINQ'
    meta['dataFormat'] = 'AMOR-NEXUS-HDF5'
    meta['sourceFolder'] = ''
    ...
    # AMOR specific data
    meta['chopper_speed'] = getDictItem(scientificmeta, '/entry1/AMOR/T0_chopper/rotation_speed')
